...
/**
 * MR_Rating_Entry_Value_Table class
 * @author dpowney
 *
 */
class MR_Rating_Entry_Value_Table extends WP_List_Table {
	...
	function extra_tablenav( $which ) {
		...
		if ( $which == "top" ){
			$rating_item_entry_id = $this->get_entry_id();
	...
	function get_columns() {
		return array(
				MR_Rating_Entry_Value_Table::RATING_ITEM_ENTRY_ID_COLUMN =>__( 'Rating Item Entry Id', 'multi-rating' ),
				MR_Rating_Entry_Value_Table::RATING_ITEM_ID_COLUMN => __( 'Rating Item Id', 'multi-rating' ),
				MR_Rating_Entry_Value_Table::DESCRIPTION_COLUMN =>__( 'Description' , 'multi-rating' ),
				MR_Rating_Entry_Value_Table::VALUE_COLUMN	=>__( 'Value', 'multi-rating' ),
				MR_Rating_Entry_Value_Table::MAX_OPTION_VALUE_COLUMN => __( 'Max Option Value', 'multi-rating' )
		);
	}
	...
	function prepare_items() {
		...
		$hidden = array( MR_Rating_Entry_Value_Table::RATING_ITEM_ENTRY_ID_COLUMN, MR_Rating_Entry_Value_Table::RATING_ITEM_ID_COLUMN );
	...
	function column_default( $item, $column_name ) {
		switch( $column_name ) {
			case MR_Rating_Entry_Value_Table::RATING_ITEM_ENTRY_ID_COLUMN :
			case MR_Rating_Entry_Value_Table::RATING_ITEM_ID_COLUMN :
			case MR_Rating_Entry_Value_Table::DESCRIPTION_COLUMN :
			case MR_Rating_Entry_Value_Table::VALUE_COLUMN :
			case MR_Rating_Entry_Value_Table::MAX_OPTION_VALUE_COLUMN :
	...
	private function get_entry_id() {
		if (isset($_POST['entry-id'])) {
			return $_POST['entry-id'];
		} else if (isset($_GET['entry-id'])) {
