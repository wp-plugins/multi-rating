...
class Rating_Item_Table extends WP_List_Table {
	...
	function get_columns() {
		...
		return array(
				...
				Rating_Item_Table::RATING_ITEM_ID_COLUMN =>__( 'Rating Item ID', 'multi-rating' ),
				Rating_Item_Table::RATING_ID_COLUMN => '',
				Rating_Item_Table::DESCRIPTION_COLUMN =>__( 'Description' , 'multi-rating' ),
				Rating_Item_Table::TYPE_COLUMN => __( 'Type', 'multi-rating' ),
				Rating_Item_Table::WEIGHT_COLUMN	=>__( 'Weight', 'multi-rating' ),
				Rating_Item_Table::DEFAULT_OPTION_VALUE_COLUMN => __( 'Default Option Value', 'multi-rating' ),
				Rating_Item_Table::MAX_OPTION_VALUE_COLUMN => __( 'Max Option Value', 'multi-rating' )
		);
	}
