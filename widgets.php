...
class Top_Rating_Results_Widget extends WP_Widget {
	function __construct() {
		$widget_ops = array('classname' => 'top-rating-results-widget', 'description' => __('Displays the Top Rating Results for the Multi Rating results.'));
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
		Multi_Rating_API::display_top_rating_results(array('limit' => $limit, 'title' => $title, 'show_category_filter' => $show_category_filter, 'category_id' => $category_id, 'class' => 'widget'));
		echo $after_widget;
	}
	...
	function form( $instance ) {
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_category_filter'); ?>"><?php _e('Show Category Filter'); ?></label>
		</p>
		<?php
	}
}
